...
{
	public float maxMoveDelta = 0.25f; // maximum distance one vertice moves per explosion (in meters)
	...
	public void OnCollisionEnter( Collision collision ) 
	{
		...
		//Debug.DrawLine(collision.contacts[0].point, transform.position, Color.red, 1f);
		//Debug.Break();
	}
